...
export const i18nConstants = {
  "en-US": {
    ...
    user: {
      ...
      signUpTips1: "Please carefully verify that your basic personal information is accurate and that all attachments have been uploaded correctly. Please note that after successful registration, all information except your chosen preferred group can still be modified.",
  ...
  "zh-CN": {
    ...
    user: {
      ...
      signUpTips: "你将报名",
      signUpTips1: "请您仔细核对所填写的个人基本信息是否准确无误，并确认所有附件已正确上传。成功报名后，除了所选择的意向组别外，其他信息依然可以修改。",
