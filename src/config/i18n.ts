...
export const i18nConstants = {
	"en-US": {
		...
		history: {
			...
			mobile: {
				notSignUpTips:
					"Please fill in basic information, intended group, resume, etc. for sign up to help us get to know you better.",
				signUpTips:
					"You have successfully registered for the {recruitment} {group} group. You can modify your personal information at any time before the registration ends.",
				known: "I know",
				input: "Fill out",
				change: "Edit ",
				...
				groupInterviewTips:
					"Group interviews will be conducted by students from the intended group. Please select a time first.",
				selectTime: "Select Time",
				confirm: "confirm",
				cancel: "cancel",
				teamInterviewTips:
					"Team interview is the last step to join us. The purpose is to let the team members get to know you better."
			}
		},
		user: {
			...
			isQuick: "SpeedRun",
			isQuickTips:
				"After sign up for SpeedRun, the written test process will be skipped, and there is no need to take the test after passing the group interview. If you do not pass the interview, you can continue with the normal process and participate in recruitment.",
			groupTips:
				"You can 1. choose only one regular group 2. choose only the Blockchain group 3. choose one regular group and the Blockchain group",
			projectCTips: "What is Blockchain?",
			BlockchainTips:
				"For this recruitment, you can either apply specifically for the Blockchain group (by selecting it under 'Preferred Group'), or you can apply for other groups while also checking the option to participate in the Blockchain group.",
			quick: "yes",
			notQuick: "no",
			...
			signUp: "sign up",
			signUpConfirm:
				"You will sign up for {recruitment}, basic information, resume, and portfolio will be uploaded, please fill them in carefully",
			placeholder: "input text here",
			signUpTips: "you will sign up",
			signUpTips1:
				"Please carefully verify that your basic personal information is accurate and that all attachments have been uploaded correctly. Please note that after successful registration, all information except your chosen preferred group can still be modified.",
			resumePopover:
	...
	"zh-CN": {
		...
		user: {
			...
			isQuick: "是否快通",
			isQuickTips:
				"报名快速通道后，将跳过笔试流程，通过小组面试后无需进行熬测。若未通过面试，也可以继续进行正常流程参与招新",
			groupTips:
				"意向组别选择。你可以 1.仅选择一个常规组别 2.仅选择 Blockchain 组别 3.选择一个常规组别并选择 Blockchain 组别",
			projectCTips: "什么是Blockchain?",
			BlockchainTips:
				"本次招新可以单独报名 Blockchain 组（在意向组别处选择），或者报名其他组别的同时勾选参加 Blockchain 计划",
			quick: "是",
			notQuick: "否",
			rank: "加权排名",
			phone: "电话",
